...
from rhautoregression.nn.ops.masked_conv2d import MaskedConv2d
from rhautoregression.nn.heads.channel_causal_logit_head import ChannelCausalLogitHead
from rhautoregression.nn.backbones.spatial_only_ar_conv_backbone import SpatialOnlyARConvBackbone

from rhautoregression.nn.utils.sample_from_logits import sample_backbone1_headN as sample

class PixelCNNMinusMinus(nn.Module):
    ...
    def __init__(
        ...
        self.backbone = SpatialOnlyARConvBackbone(
...
if __name__ == "__main__":
    ...
    model = PixelCNNMinusMinus(vocab_size=256, in_channels=C, hidden_channels=120,   # divisible by 3
                               n_blocks=4, kernel_size=5, embed_dim=32, dropout=0.0,).to(device)
